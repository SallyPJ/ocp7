...
def display_results(execution_time, best_combination, best_profit, best_combination_cost):
...
def main():
    ...
    best_combination, best_profit, best_combination_cost = greedy_best_combination(actions, BUDGET)
    end_time = time.time()
    execution_time = end_time - start_time

    display_results(execution_time, best_combination, best_profit, best_combination_cost)
